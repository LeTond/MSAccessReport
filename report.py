...
class Report:
    def generate_week_document(self, dict_: dict, period: str) -> None:
        ...
        for x, y, z in self.create_week_table(dict_):
    ...
    def create_week_table(dict_: dict) -> tuple:
        ...
        table_records = (
            ...
            ('ВМП', dict_['C контрастом']['ВМП'], dict_['Без контраста']['ВМП']),
            ('ОМС стац', dict_['C контрастом']['ОМС стац'], dict_['Без контраста']['ОМС стац']),
            ('Платно', dict_['C контрастом']['Пл'], dict_['Без контраста']['Пл']),
            ('Сотрудники', dict_['C контрастом']['Сотр'], dict_['Без контраста']['Сотр']),
            ('ДМС', dict_['C контрастом']['ДМС'], dict_['Без контраста']['ДМС']),
            ('ОМС амб', dict_['C контрастом']['ОМС амб'], dict_['Без контраста']['ОМС амб']),
            ('Клиническая апробация', dict_['C контрастом']['КА'], dict_['Без контраста']['КА']),
            ('Грант', dict_['C контрастом']['Грант'], dict_['Без контраста']['Грант']),
            ('Наука', dict_['C контрастом']['Наука'], dict_['Без контраста']['Наука'])
        )
    ...
    def create_month_table(dict_: dict) -> tuple:
        ...
        table_records = (
            ...
            ('прочих органов и систем (Гипофиз, ХСО, орбиты)', dict_['Всего']['Прочие'], dict_['C контрастом']['Прочие'],
